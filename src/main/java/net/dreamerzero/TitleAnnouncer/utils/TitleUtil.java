...
public class TitleUtil {
    public static void sendTitle(final Component anuntitle, final Component anunsubtitle, final Audience audience, final int fadein, final int stay, final int fadeout) {
        //Title Duration
